...
export const ProjectSchema = z.object({
  ...
  appType: z.enum(["Notebook", "Dashboard", "BI Report", "SQL", "ML Model", "API", "Other"]).default("Dashboard"),
  icon: z.object({
...
export const DEFAULT_PORTFOLIO: Portfolio = {
  ...
  presentation: "Hi, I'm Alex. I specialize in SQL, Python, and dashboarding. I love transforming messy data into clear stories.",
  contact: {
    email: "alex.da@example.com",
    phone: "",
    location: "Buenos Aires, AR",
    website: "https://alexda.dev",
    socials: [
      { label: "LinkedIn", url: "https://linkedin.com/in/alexda" },
      { label: "GitHub", url: "https://github.com/alexda" },
      { label: "Kaggle", url: "https://kaggle.com/alexda" }
    ]
  },
  theme: {
    layout: "minimalistic",
  ...
  projects: [
    {
      ...
      description: "Power BI dashboard tracking weekly revenue, retention, and product mix.",
